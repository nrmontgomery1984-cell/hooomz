              ...
              <div style={{ display: 'flex', gap: 6, overflowX: 'auto' }}>
                <button
                  ...
                  style={{
                    ...
                    color: tradeFilter === 'all' ? '#fff' : 'var(--mid)',
                    whiteSpace: 'nowrap',
                  }}
                >
                  All ({sops.length})
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        color: tradeFilter === t ? '#fff' : 'var(--mid)',
                        whiteSpace: 'nowrap',
                      }}
                    >
                      {t} ({count})
        ...
        <div className="max-w-lg md:max-w-full mx-auto px-4 md:px-6 py-4">
          {filtered.length === 0 ? (
            <div style={{
              ...
              <FileCheck size={32} style={{ margin: '0 auto 12px', color: 'var(--muted)' }} />
              <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--mid)' }}>No SOPs Found</p>
