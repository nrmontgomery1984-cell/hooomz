...
const CURRENT_PHASE: ScriptPhase = 'shield';

// ============================================================================
// SHIELD CHECKLIST TEMPLATE
// ============================================================================

const SHIELD_CHECKLIST: ChecklistItem[] = [
  { id: 1, type: 'auto', label: 'Site visit booked and confirmed in calendar', note: '⚡ Automated — syncs to company + client calendar', checked: false },
  { id: 2, type: 'normal', label: 'Pre-site checklist sent to client', note: 'Clear furniture, confirm access, parking instructions', checked: false },
  { id: 3, type: 'killer', label: 'Site walkthrough completed with client before work begins', note: '⚑ Confirm scope, access, and protection requirements face to face', checked: false },
  { id: 4, type: 'normal', label: 'All furniture and belongings moved or covered', note: '', checked: false },
  { id: 5, type: 'normal', label: 'Floor protection laid — all traffic areas covered', note: '', checked: false },
  { id: 6, type: 'normal', label: 'Wall and door frame masking complete', note: '', checked: false },
  { id: 7, type: 'normal', label: 'Dust containment set up for demo areas', note: '', checked: false },
  { id: 8, type: 'killer', label: 'Client confirmed — vacated or aware of full work schedule', note: '⚑ No surprises on site', checked: false },
  { id: 9, type: 'normal', label: 'Pre-work site photos taken — existing conditions documented', note: 'Minimum 3 per room — overview, floor, transitions', checked: false },
  { id: 10, type: 'normal', label: 'Lock S phase with performance colour → advance to Clear', note: '🟢 Full protection + photos + client briefed · 🟡 Partial · 🔴 Skipped steps', checked: false },
];
...
export default function ShieldPage() {
  const [projects, setProjects] = useState(() =>
    MOCK_PROJECTS
      .filter((p) => p.phases.shield.status === 'active')
      .map((p) => ({ ...p, checklist: SHIELD_CHECKLIST.map((c) => ({ ...c })) }))
  );
