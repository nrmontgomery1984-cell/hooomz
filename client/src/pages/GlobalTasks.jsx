...
import { useProjects, useProjectScope } from '../hooks/useProjects'
...
/**
 * Global Tasks Page
 * Unified task view across all projects with project selection dropdown
 */
const GlobalTasks = () => {
  ...
  const { project, loading: projectLoading, updateScopeItem } = useProjectScope(selectedProjectId)
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Manage tasks across all your projects</p>
          </div>
